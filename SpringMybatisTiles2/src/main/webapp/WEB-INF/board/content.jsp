...
<h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Board_Detail</h2>
<!-- Icon Divider-->
...
<body>
	<table style="margin-left: auto; margin-right: auto; width: 500px;" class="table table-bordered">
		<tr>
		...
		<tr>
			<td>작성자: ${dto.writer } <span style="margin-left: 300px; color: gray">조회: ${dto.readcount }</span> <br> <pre>
